   ...
   <div className='container sticky-md-top  d-md-flex flex-md-row bg-black vh-30 bg-body-tertiary  mt-4 mb-4 '>
    ...
    <div className="container d-md-flex flex-md-row justify-content-end  ">
         {islogin && <><div className='align-content-center me-3'><Link to='/menu' className='nav-item col text-secondary text-decoration-none '>Menu</Link></div>
           <div className='align-content-center me-3 '><Link to='/cart' className='nav-item col text-secondary text-decoration-none'>Cart  {cart?.length!==0 ?'('+cart.length+')':'(0)'} </Link></div>
          ...
          {islogin && role!=='seller'&& <div className='align-content-center me-3 '><Link to='/Orders' className='nav-item col text-secondary text-decoration-none'>Orders</Link></div>}
           {islogin && role==='seller'&& <div className='align-content-center me-3 '><Link to='/admin' className='nav-item col text-secondary text-decoration-none'>Admin</Link></div>}
